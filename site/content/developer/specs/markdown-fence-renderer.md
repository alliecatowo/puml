+++
title = "puml-markdown Code Fence Renderer Specification"
description = "How `puml --from-markdown` extracts and renders fenced blocks."
weight = 70
+++

> Mirror of [`docs/specs/puml_markdown_fence_renderer_spec(1).md`](https://github.com/alliecatowo/puml/blob/main/docs/specs/puml_markdown_fence_renderer_spec(1).md) &mdash; the in-repo file is the source of truth.
