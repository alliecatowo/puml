+++
title = "puml-agent-pack Codex / Claude Plugin + MCP Specification"
description = "Agent / MCP plugin surface for Codex, Claude, and friends."
weight = 80
+++

> Mirror of [`docs/specs/puml_agent_plugin_mcp_spec.md`](https://github.com/alliecatowo/puml/blob/main/docs/specs/puml_agent_plugin_mcp_spec.md) &mdash; the in-repo file is the source of truth.
