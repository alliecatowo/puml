+++
title = "puml-syntax Shared Syntax + Highlighting Specification"
description = "Token taxonomy across grammars and LSP semantic tokens."
weight = 40
+++

> Mirror of [`docs/specs/puml_syntax_highlighting_spec(1).md`](https://github.com/alliecatowo/puml/blob/main/docs/specs/puml_syntax_highlighting_spec(1).md) &mdash; the in-repo file is the source of truth.
