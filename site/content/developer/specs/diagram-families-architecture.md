+++
title = "Diagram Families Architecture Spec"
description = "Per-family compile contract and module layout."
weight = 20
+++

> Mirror of [`docs/specs/diagram_families_architecture_spec.md`](https://github.com/alliecatowo/puml/blob/main/docs/specs/diagram_families_architecture_spec.md) &mdash; the in-repo file is the source of truth.
