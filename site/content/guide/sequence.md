...
PlantUML 1:1 parity is the roadmap goal, not the current claim. See [`docs/parity-roadmap.md`](https://github.com/alliecatowo/puml/blob/main/docs/parity-roadmap.md) and linked issues for current compatibility work.
