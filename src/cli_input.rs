...
use crate::{EXIT_INTERNAL, EXIT_IO};

pub(crate) const SUPPORTED_MARKDOWN_FENCES: &str =
    "puml, pumlx, picouml, plantuml, uml, puml-sequence, uml-sequence, mermaid";

#[derive(Debug, Clone)]
pub(crate) struct InputDiagram {
    pub(crate) source: String,
    pub(crate) source_span: Option<Span>,
    pub(crate) frontend_hint: Option<FrontendSelection>,
    pub(crate) output_name_hint: Option<String>,
}
...
pub(crate) fn should_extract_markdown(from_markdown_flag: bool, input_path: Option<&Path>) -> bool {
...
pub(crate) fn frontend_hint_for_path(path: Option<&Path>) -> Option<FrontendSelection> {
...
pub(crate) fn map_diagnostic_span(mut d: Diagnostic, mapping: Option<Span>) -> Diagnostic {
...
pub(crate) fn missing_markdown_output_name(idx: usize) -> (u8, String) {
    (
        EXIT_INTERNAL,
