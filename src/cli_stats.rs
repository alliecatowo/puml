...
mod tests {
    ...
    #[test]
    fn stats_participant_role_labels_cover_cli_schema() {
        let cases = [
            (ParticipantRole::Participant, "participant"),
            (ParticipantRole::Actor, "actor"),
            (ParticipantRole::Boundary, "boundary"),
    ...
    #[test]
    fn stats_component_kind_labels_cover_cli_schema() {
        let cases = [
            (ComponentNodeKind::Action, "action"),
            (ComponentNodeKind::Agent, "agent"),
            (ComponentNodeKind::Component, "component"),
    ...
    #[test]
    fn stats_activity_and_timing_kind_labels_cover_cli_schema() {
        let activity_cases = [
            (ActivityStepKind::Start, "activity-start"),
            (ActivityStepKind::Stop, "activity-stop"),
            (ActivityStepKind::End, "activity-end"),
    ...
    #[test]
    fn stats_group_and_diagram_kind_labels_cover_cli_schema() {
        for (kind, label) in [
            ("namespace", "namespace"),
            ("package", "package"),
            ("together", "together"),
