// Family: @startmath / @startlatex
//
// The specialized math renderer is intentionally separate from the generic
// renderer pipeline. Keep parsing, layout, and public entry points isolated so
// the raw-source CLI/WASM path and normalized-model LSP path call the same core
// implementation without reconstructing source wrappers.
...
use layout::{layout_group, BASE_FONT, SVG_MATH_FONT_FAMILY};
use parser::parse_math_expr;
