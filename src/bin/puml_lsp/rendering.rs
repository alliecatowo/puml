use super::document::lsp_parse_with_frontend;
use puml::{normalize_family, try_render_svg_pages_from_model, FrontendSelection};
use serde_json::{json, Value};

pub(crate) fn render_result(src: &str, frontend: Option<FrontendSelection>) -> Value {
...
pub(crate) fn lsp_frontend_hint(params: &Value) -> Option<FrontendSelection> {
    let raw = params
        .get("frontend")
