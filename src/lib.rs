mod api;
/// Stable worker protocol message types for browser / IDE workers.
pub use api::worker;
pub mod ast;
mod bootstrap_icons;
pub mod creole;
...
pub use api::{
    compile, compile_with_options, detect_diagram_family, dispatch, dispatch_with_options,
    extract_markdown_diagrams, lsp_capabilities, normalize, normalize_family,
    normalized_artifact_scene_summary_to_json, normalized_model_summary_to_json,
    normalized_scene_summary_to_json, parse, parse_with_pipeline_options,
    parse_with_pipeline_result_options, preprocess_with_pipeline_options,
    preprocess_with_pipeline_result_options, render_artifact_pages_from_model,
    ...
    render_source_to_texts, render_svg_pages_from_model, CompatMode, CompileResult, DiagnosticDto,
    DiagramFamily, DiagramInput, DocumentSymbolDto, FrontendSelection, LanguageServiceSurface,
    ModelSummary, ParsePipelineOptions, ParsePipelineResult, PreprocessPipelineResult,
    SemanticTokenDto, SpanDto, WorkerRequest, WorkerRequestPayload, WorkerResponse,
