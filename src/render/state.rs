...
#[derive(Clone)]
struct StateProjectionRow {
    depth: usize,
    label: String,
}

fn state_projection_format(node: &StateNode) -> &str {
...
fn state_projection_layout(node: &StateNode) -> (String, Vec<StateProjectionRow>) {
...
fn extract_state_projection_rows(body: &str, format: &str) -> Vec<StateProjectionRow> {
    if format == "json" {
...
fn parse_state_projection_json_value(body: &str) -> Option<serde_json::Value> {
...
fn parse_state_projection_yaml_value(body: &str) -> Option<yaml_rust2::Yaml> {
...
fn collect_state_projection_json_rows(
    label: Option<String>,
...
fn collect_state_projection_yaml_rows(
    label: Option<String>,
...
fn state_projection_yaml_label(value: &yaml_rust2::Yaml) -> String {
    match value {
...
fn extract_state_yaml_kv_lines(body: &str) -> Vec<String> {
...
fn extract_state_json_kv_lines(body: &str) -> Vec<String> {
    let mut lines = Vec::new();
    for raw in body.lines() {
...
fn parse_state_json_kv_display(segment: &str) -> Option<String> {
