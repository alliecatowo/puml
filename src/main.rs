...
use clap::Parser;
use cli::{
    Cli, Command as CliCommand, CompatMode as CliCompatMode, DeterminismMode as CliDeterminismMode,
    DiagnosticsFormat, Dialect as CliDialect, DumpKind, FormatArgs, LintReportFormat, OutputFormat,
};
use glob::glob;
