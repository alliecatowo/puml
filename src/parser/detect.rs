...
pub(crate) fn detect_non_sequence_family(line: &str) -> Option<DiagramKind> {
    ...
    if line.starts_with("component ")
        ...
        || c4_line.starts_with("person(")
        || c4_line.starts_with("system(")
        || c4_line.starts_with("system_ext(")
        || c4_line.starts_with("systemext(")
        || c4_line.starts_with("system_db(")
        || c4_line.starts_with("systemdb(")
        || c4_line.starts_with("container(")
        || c4_line.starts_with("container_ext(")
        || c4_line.starts_with("containerext(")
        || c4_line.starts_with("container_db(")
        || c4_line.starts_with("containerdb(")
        || c4_line.starts_with("component(")
        || c4_line.starts_with("component_ext(")
        || c4_line.starts_with("componentext(")
        || c4_line.starts_with("component_db(")
        || c4_line.starts_with("componentdb(")
        || c4_line.starts_with("boundary(")
        || c4_line.starts_with("person_ext(")
        || c4_line.starts_with("personext(")
        || c4_line.starts_with("person-ext(")
