...
pub(super) struct ScopedGroupContent {
    pub(super) members: Vec<String>,
    pub(super) relations: Vec<FamilyRelation>,
}
...
pub(super) fn parse_class_scoping_block(
    lines: &[(&str, Span)],
    start: usize,
    line: &str,
...
pub(super) fn qualify_scoped_identifier(name: String, scope: &[String]) -> String {
...
pub(super) fn qualify_scoped_relation(mut rel: FamilyRelation, scope: &[String]) -> FamilyRelation {
    rel.from = qualify_scoped_identifier(rel.from, scope);
    rel.to = qualify_scoped_identifier(rel.to, scope);
    rel
}

pub(super) fn group_body_contains_component_family(
    lines: &[(&str, Span)],
    start: usize,
    end_idx: usize,
) -> bool {
...
pub(super) fn group_body_contains_class_family(
    lines: &[(&str, Span)],
    start: usize,
    end_idx: usize,
) -> bool {
...
pub(super) fn group_body_contains_object_family(
    lines: &[(&str, Span)],
    start: usize,
    end_idx: usize,
) -> bool {
...
pub(super) fn group_body_contains_usecase_family(
    lines: &[(&str, Span)],
    start: usize,
    end_idx: usize,
) -> bool {
...
pub(super) fn scoped_family_kind_for_block(
    lines: &[(&str, Span)],
    start: usize,
    end_idx: usize,
) -> DiagramKind {
