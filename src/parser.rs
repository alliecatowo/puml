...
use crate::ast::{
    ClassDecl, ClassMember, DiagramKind, Document, FamilyRelation, Group, MemberModifier, Message,
    Note, ObjectDecl, ParticipantDecl, ParticipantRole, StateDecl, StateInternalAction,
    StateTransition, Statement, StatementKind, UseCaseDecl, VirtualEndpoint, VirtualEndpointKind,
    VirtualEndpointSide,
};
