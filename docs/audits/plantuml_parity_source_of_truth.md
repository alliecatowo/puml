...
| gantt+chronology | advanced | Full scale/resource semantics | partial | `tests/fixtures/timeline/valid_gantt_render.puml`, `tests/fixtures/timeline/valid_chronology_render.puml` | https://plantuml.com/chronology-diagram |
