...
| usecase | advanced | Include/extend/style depth | partial | `tests/fixtures/families/valid_usecase_bootstrap.puml`, `tests/integration.rs` | https://plantuml.com/use-case-diagram |
...
| preprocessor | advanced | Dynamic invocation and full expression/data-helper breadth | partial | `tests/fixtures/preprocessor/valid_macro_expr_collection_depth.puml`, `tests/integration.rs::preproc_nested_json_mutation_and_projection_helpers_expand`, `tests/integration.rs::preprocessor_macro_expression_and_collection_depth_expand` | https://plantuml.com/preprocessing |
...
| gantt+chronology | advanced | Full scale/resource semantics | partial | `tests/fixtures/timeline/valid_gantt_render.puml`, `tests/fixtures/timeline/valid_gantt_dates_proportional.puml`, `tests/fixtures/timeline/valid_chronology_render.puml`, `tests/fixtures/families/valid_gantt_calendar_resource_scale.puml`, `tests/parity_wave_csv_timeline_activity.rs` including scale, closed/open calendar exceptions, resource load math metadata, baselines, critical markers, dependency endpoints, and multi-resource evidence | https://plantuml.com/chronology-diagram |
...
| mindmap+wbs | advanced | Orientation/styling parity depth | partial | `docs/examples/mindmap/01_basic.svg`, `docs/examples/wbs/01_basic.svg`, `tests/parity_wave_csv_timeline_activity.rs` including WBS orientation and node color tag evidence | https://plantuml.com/wbs-diagram |
