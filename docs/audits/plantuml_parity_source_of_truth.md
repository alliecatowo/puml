...
| class | advanced | Full class styling/edge semantics | partial | `tests/fixtures/families/valid_class_visibility.puml` | https://plantuml.com/class-diagram |
...
| component | advanced | Interface/port/style breadth | partial | `tests/fixtures/families/valid_component.puml` | https://plantuml.com/component-diagram |
...
| state | advanced | Full state styling/edge semantics | partial | `tests/fixtures/families/valid_state_history.puml` | https://plantuml.com/state-diagram |
...
| activity | advanced | New-style activity breadth | partial | `tests/fixtures/families/valid_activity_colored_lane.puml` | https://plantuml.com/activity-diagram-beta |
...
| timing | advanced | Full timing semantics breadth | partial | `tests/fixtures/families/valid_timing.puml` | https://plantuml.com/timing-diagram |
...
| gantt+chronology | advanced | Full scale/resource semantics | partial | `tests/fixtures/timeline/valid_gantt_render.puml`, `tests/fixtures/timeline/valid_chronology_render.puml`, `tests/parity_wave_csv_timeline_activity.rs` | https://plantuml.com/chronology-diagram |
